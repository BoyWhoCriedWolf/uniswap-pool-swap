 ...
 */
export declare type OnSwapQuote = (args: Omit<GetQuoteArgs, 'provider' | 'onQuote'>, quote: WidgetPromise<TradeResult>) => void;
/**
 ...
 */
export declare type OnTokenAllowance = (args: {
    token: Token;
    spender: string;
 ...
 */
export declare type OnPermit2Allowance = (args: {
    token: Token;
    spender: string;
 ...
 */
export declare type OnSwapSend = (args: {
 ...
 * @param transaction resolves with the swap transaction info when it is sent to the mempool.
 */
export declare type OnWrapSend = (args: {
