export declare enum UniswapXOrderStatus {
    FILLED = "filled",
    OPEN = "open",
    EXPIRED = "expired",
    ERROR = "error",
...
interface NonfilledUniswapXBackendOrder extends BaseUniswapXBackendOrder {
    orderStatus: UniswapXOrderStatus.OPEN | UniswapXOrderStatus.EXPIRED | UniswapXOrderStatus.ERROR | UniswapXOrderStatus.CANCELLED | UniswapXOrderStatus.INSUFFICIENT_FUNDS;
}
