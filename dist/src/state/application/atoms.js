...
var storage = createJSONStorage(function () {
  return sessionStorage;
});
var shouldDisableNFTRoutesAtom = atomWithStorage("shouldDisableNFTRoutes", false, storage);

export { shouldDisableNFTRoutesAtom };
