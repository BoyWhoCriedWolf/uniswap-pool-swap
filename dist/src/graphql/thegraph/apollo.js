...
var authMiddleware = new ApolloLink(function (operation, forward) {
  ...
  var chainId = store.getState().application.chainId;
...
_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, ChainId.MAINNET, new ApolloClient({
  cache: new InMemoryCache(),
  uri: CHAIN_SUBGRAPH_URL[ChainId.MAINNET]
