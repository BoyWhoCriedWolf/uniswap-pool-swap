...
import { formatSwapSignedAnalyticsEventProperties } from '../lib/utils/analytics.js';
import { useCallback } from 'react';
import { TradeFillType } from '../state/routing/types.js';
import { trace } from '../tracing/trace.js';
import { UserRejectedRequestError, SignatureExpiredError } from '../utils/errors.js';
import { signTypedData } from '../utils/signing.js';
...
function _getUpdatedNonce() {
  _getUpdatedNonce = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(swapper, chainId) {
    ...
    return _regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 6:
          ...
          return _context4.abrupt("return", BigNumber.from(nonce));
        case 11:
          _context4.prev = 11;
...
function useUniswapXSwapCallback(_ref) {
  ...
  return useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
    return _regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          return _context3.abrupt("return", trace("swapx.send", /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                        ...
                        return _regeneratorRuntime.wrap(function _callee$(_context) {
                          while (1) switch (_context.prev = _context.next) {
                            ...
                            case 3:
                              ...
                              _updatedOrder = DutchOrderBuilder.fromOrder(trade.order).decayStartTime(startTime).decayEndTime(endTime).deadline(deadline).swapper(account).nonFeeRecipient(account)
                            ...
                            case 20:
                              ...
                              if (!(_context.t0 instanceof SignatureExpiredError)) {
                                _context.next = 24;
                                break;
                              }
                              throw _context.t0;
                            case 24:
                              ...
                              throw new UserRejectedRequestError(swapErrorToUserReadableMessage(_context.t0));
                            case 27:
                              throw new Error(swapErrorToUserReadableMessage(_context.t0));
                            case 28:
                            case "end":
                  ...
                  case 20:
                    ...
                    sendAnalyticsEvent("UniswapX Order Post Error", _objectSpread(_objectSpread(_objectSpread({}, formatSwapSignedAnalyticsEventProperties({
                      trade: trade,
                      allowedSlippage: allowedSlippage,
                      fiatValues: fiatValues
                    })), analyticsContext), {}, {
...
export { useUniswapXSwapCallback };
