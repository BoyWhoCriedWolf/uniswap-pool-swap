import { Protocol, partitionMixedRouteByProtocol } from '@uniswap/router-sdk';
import { Percent, CurrencyAmount } from '@uniswap/sdk-core';
import { Pair } from '@uniswap/v2-sdk';
import { Pool } from '@uniswap/v3-sdk';
import { useWeb3React } from '@web3-react/core';
import { L2_CHAIN_IDS, SUPPORTED_GAS_ESTIMATE_CHAIN_IDS } from '../constants/chains.js';
import JSBI from 'jsbi';
import useNativeCurrency from '../lib/hooks/useNativeCurrency.js';
import { useMemo } from 'react';
import useGasPrice from './useGasPrice.js';
import useStablecoinPrice, { useStablecoinValue, useStablecoinAmountFromFiatValue } from './useStablecoinPrice.js';
...
var DEFAULT_AUTO_SLIPPAGE = new Percent(5, 1000); // 0.5%
...
var MAX_AUTO_SLIPPAGE_TOLERANCE = new Percent(5, 100); // 5%
...
function useClassicAutoSlippageTolerance(trade) {
  ...
  var outputDollarValue = useStablecoinValue(trade === null || trade === void 0 ? void 0 : trade.outputAmount);
  var nativeGasPrice = useGasPrice();
  var gasEstimate = guesstimateGas(trade);
  var gasEstimateUSD = (_useStablecoinAmountF = useStablecoinAmountFromFiatValue(trade === null || trade === void 0 ? void 0 : trade.gasUseEstimateUSD)) !== null && _useStablecoinAmountF !== void 0 ? _useStablecoinAmountF : null;
  var nativeCurrency = useNativeCurrency(chainId);
  var nativeCurrencyPrice = useStablecoinPrice((_ref = trade && nativeCurrency) !== null && _ref !== void 0 ? _ref : undefined);
  return useMemo(function () {
    ...
    var dollarCostToUse = chainId && SUPPORTED_GAS_ESTIMATE_CHAIN_IDS.includes(chainId) && gasEstimateUSD ? gasEstimateUSD : dollarGasCost;
...
export { useClassicAutoSlippageTolerance as default };
