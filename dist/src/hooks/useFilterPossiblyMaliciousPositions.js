...
import { hasURL } from '../utils/urlChecks.js';
import { useDefaultActiveTokens } from './Tokens.js';
import { useTokenContractsConstant } from './useTokenContractsConstant.js';
...
function useFilterPossiblyMaliciousPositions(positions) {
  ...
  var activeTokensList = useDefaultActiveTokens(chainId);
  var nonListPositionTokenAddresses = useMemo(function () {
  ...
  var symbolCallStates = useTokenContractsConstant(nonListPositionTokenAddresses, "symbol");
  var addressesToSymbol = useMemo(function () {
    var result = {};
...
export { useFilterPossiblyMaliciousPositions };
