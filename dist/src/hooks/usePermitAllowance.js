...
import PERMIT2_ABI from '../abis/permit2.json.js';
import { useContract } from './useContract.js';
import { useSingleCallResult } from '../lib/hooks/multicall.js';
import ms from 'ms';
import { useMemo, useState, useEffect, useCallback } from 'react';
import { toReadableError, UserRejectedRequestError } from '../utils/errors.js';
...
var PERMIT_EXPIRATION = ms("30d");
var PERMIT_SIG_EXPIRATION = ms("30m");
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          _AllowanceTransfer$ge = AllowanceTransfer.getPermitData(permit, PERMIT2_ADDRESS, chainId), domain = _AllowanceTransfer$ge.domain, types = _AllowanceTransfer$ge.types, values = _AllowanceTransfer$ge.values;
          _context.next = 15;
        ...
        case 20:
          ...
          throw new UserRejectedRequestError("".concat(symbol, " permit allowance failed: User rejected signature"));
        case 25:
          throw toReadableError("".concat(symbol, " permit allowance failed:"), _context.t0);
        case 26:
        case "end":
...
export { usePermitAllowance, useUpdatePermitAllowance };
