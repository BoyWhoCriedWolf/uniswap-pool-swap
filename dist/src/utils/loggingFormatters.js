...
import { getDurationUntilTimestampSeconds, getTokenAddress, formatToDecimal, formatPercentInBasisPointsNumber, formatPercentNumber } from '../lib/utils/analytics.js';
import { TradeFillType } from '../state/routing/types.js';
import { isClassicTrade } from '../state/routing/utils.js';
import { computeRealizedPriceImpact } from './prices.js';
...
var formatSwapButtonClickEventProperties = function formatSwapButtonClickEventProperties(_ref) {
  ...
  return _objectSpread({
    ...
    transaction_hash: (swapResult === null || swapResult === void 0 ? void 0 : swapResult.type) === TradeFillType.Classic ? swapResult.response.hash : undefined,
    order_hash: (swapResult === null || swapResult === void 0 ? void 0 : swapResult.type) === TradeFillType.UniswapX ? swapResult.response.orderHash : undefined,
...
export { formatSwapButtonClickEventProperties, formatSwapPriceUpdatedEventProperties };
