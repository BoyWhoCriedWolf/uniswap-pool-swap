...
_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, SortBy.HighToLow, "highest"), SortBy.LowToHigh, "lowest"), SortBy.RareToCommon, "rare"), SortBy.CommonToRare, "common");
_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, SortBy.HighToLow, {
  field: "PRICE",
  asc: false
}), SortBy.LowToHigh, {
  field: "PRICE",
  ...
  return _objectSpread(_objectSpread({}, initialCollectionFilterState), {}, {
    ...
    addMarket: function addMarket(market) {
      return set(function (_ref) {
        ...
        return {
          markets: [].concat(_toConsumableArray(markets), [market])
        };
      });
    },
    ...
    addTrait: function addTrait(trait) {
      return set(function (_ref3) {
        ...
        return {
          traits: [].concat(_toConsumableArray(traits), [trait])
        };
      });
    },
...
export { SortBy, initialCollectionFilterState };
