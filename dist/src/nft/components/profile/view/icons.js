...
var useEmptyStateIconColors = function useEmptyStateIconColors() {
  var theme = useTheme();
  var primary = theme.darkMode ? colors.gray150 : colors.gray600;
  var secondary = theme.darkMode ? colors.gray600 : colors.gray300;
  return {
    primary: primary,
    secondary: secondary
  };
...
export { EmptyActivityIcon, EmptyNftsIcon, EmptyPoolsIcon, EmptyTokensIcon };
