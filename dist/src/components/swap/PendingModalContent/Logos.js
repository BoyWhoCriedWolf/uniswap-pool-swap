...
import { ReactComponent as SvgPapersText } from '../../../assets/svg/papers-text.svg.js';
...
var LogoContainer = styled.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  height: 48px;\n  width: 48px;\n  position: relative;\n  display: flex;\n  border-radius: 50%;\n  overflow: visible;\n"])));
var fadeIn = keyframes(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  from { opacity: 0;}\n  to { opacity: 1;}\n"])));
var fadeAndScaleIn = keyframes(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  from { opacity: 0; transform: scale(0); }\n  to { opacity: 1; transform: scale(1); }\n"])));
var fadeInAnimation = css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  animation: ", "\n    ", ";\n"])), fadeIn, function (_ref) {
  var theme = _ref.theme;
  return "".concat(theme.transition.duration.medium, " ").concat(theme.transition.timing.inOut);
});
var fadeAndScaleInAnimation = css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  animation: ", "\n    ", ";\n"])), fadeAndScaleIn, function (_ref2) {
  var theme = _ref2.theme;
  return "".concat(theme.transition.duration.medium, " ").concat(theme.transition.timing.inOut);
});
var fadeOut = keyframes(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  from { opacity: 1; }\n  to { opacity: 0;  }\n"])));
var fadeAndScaleOut = keyframes(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  from { opacity: 1; transform: scale(1); }\n  to { opacity: 0; transform: scale(0); }\n"])));
var fadeOutAnimation = css(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  animation: ", "\n    ", ";\n"])), fadeOut, function (_ref3) {
  var theme = _ref3.theme;
  return "".concat(theme.transition.duration.medium, " ").concat(theme.transition.timing.inOut);
});
var fadeAndScaleOutAnimation = css(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  animation: ", "\n    ", ";\n"])), fadeAndScaleOut, function (_ref4) {
...
var FadeWrapper = styled.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  transition: display\n      ", ",\n    transform\n      ", ";\n  ", "\n\n  &.", " {\n    ", "\n  }\n"])), function (_ref5) {
...
function FadePresence(_ref9) {
  ...
  var ref = useRef(null);
  useUnmountingAnimation(ref, function () {
    return AnimationType.EXITING;
  });
  return /*#__PURE__*/React__default.createElement(FadeWrapper, _extends({
    ref: ref,
    className: className,
    $scale: $scale
  }, rest), children);
}
var CurrencyLoaderContainer = styled(FadePresence)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  z-index: 2;\n  border-radius: 50%;\n  transition: all\n    ", ";\n  position: absolute;\n  height: ", ";\n  width: ", ";\n  bottom: ", ";\n  right: ", ";\n  outline: ", ";\n"])), function (_ref10) {
...
var RaisedCurrencyLogo = styled(CurrencyLogo)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  z-index: 1;\n"])));
function CurrencyLoader(_ref16) {
  ...
  return /*#__PURE__*/React__default.createElement(CurrencyLoaderContainer, {
    asBadge: asBadge,
    "data-testid": "pending-modal-currency-logo-".concat(currency === null || currency === void 0 ? void 0 : currency.symbol)
  }, /*#__PURE__*/React__default.createElement(RaisedCurrencyLogo, {
    currency: currency,
    size: "100%"
  }));
}
var PinkCircle = styled(FadePresence)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  position: absolute;\n  display: flex;\n  height: 100%;\n  width: 100%;\n  border-radius: 50%;\n  align-items: center;\n  justify-content: center;\n  background-color: ", ";\n  z-index: 1;\n"])), function (_ref17) {
  var theme = _ref17.theme;
  return theme.accent1;
});
function PaperIcon() {
  return /*#__PURE__*/React__default.createElement(PinkCircle, null, /*#__PURE__*/React__default.createElement(SvgPapersText, null));
}
var LoadingIndicator = styled(LoaderV3)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  stroke: ", ";\n  fill: ", ";\n  width: calc(100% + 8px);\n  height: calc(100% + 8px);\n  top: -4px;\n  left: -4px;\n  position: absolute;\n"])), function (_ref18) {
...
function LoadingIndicatorOverlay() {
  return /*#__PURE__*/React__default.createElement(FadePresence, null, /*#__PURE__*/React__default.createElement(LoadingIndicator, null));
}
function ConfirmedIcon(_ref20) {
  var className = _ref20.className;
  var theme = useTheme();
  return /*#__PURE__*/React__default.createElement(FadePresence, {
    $scale: true
...
var IconCss = css(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  position: absolute;\n  height: 48px;\n  width: 48px;\n"])));
var AnimatedEntranceConfirmationIcon = styled(ConfirmedIcon)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  ", "\n"])), IconCss);
var AnimatedEntranceSubmittedIcon = styled(SubmittedIcon)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  ", "\n"])), IconCss);

export { AnimatedEntranceConfirmationIcon, AnimatedEntranceSubmittedIcon, AnimationType, CurrencyLoader, FadePresence, LoadingIndicatorOverlay, LogoContainer, PaperIcon };
