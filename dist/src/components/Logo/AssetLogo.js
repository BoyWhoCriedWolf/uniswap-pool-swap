...
var MissingImageLogo = styled.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  --size: ", ";\n  border-radius: 100px;\n  color: ", ";\n  background-color: ", ";\n  font-size: calc(var(--size) / 3);\n  font-weight: 535;\n  height: ", ";\n  line-height: ", ";\n  text-align: center;\n  width: ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"])), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
...
var LogoImage = styled.img(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  opacity: ", ";\n  transition: opacity\n    ", ";\n  width: ", ";\n  height: ", ";\n  border-radius: 50%;\n"])), function (_ref7) {
...
var LogoImageWrapper = styled.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  width: ", ";\n  height: ", ";\n  background: ", ";\n  transition: background-color\n    ", ";\n  box-shadow: 0 0 1px white;\n  border-radius: 50%;\n"])), function (_ref11) {
...
var L2NetworkLogo = styled.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  --size: ", ";\n  width: var(--size);\n  height: var(--size);\n  position: absolute;\n  left: 50%;\n  bottom: 0;\n  background: url(", ");\n  background-repeat: no-repeat;\n  background-size: ", ";\n  display: ", ";\n"])), function (_ref15) {
...
function AssetLogo(_ref19) {
  ...
  var isNative = _ref19.isNative,
    ...
    chainId = _ref19$chainId === void 0 ? ChainId.MAINNET : _ref19$chainId,
  ...
  var L2Icon = (_getChainInfo = getChainInfo(chainId)) === null || _getChainInfo === void 0 ? void 0 : _getChainInfo.circleLogoUrl;
  ...
  return /*#__PURE__*/React__default.createElement(LogoContainer, {
    style: _objectSpread({
      height: size,
      width: size
    }, style)
  }, src ? /*#__PURE__*/React__default.createElement(LogoImageWrapper, {
    size: size,
    imgLoaded: imgLoaded
  }, /*#__PURE__*/React__default.createElement(LogoImage, {
    src: src,
    ...
    onError: nextSrc,
    imgLoaded: imgLoaded
  })) : /*#__PURE__*/React__default.createElement(MissingImageLogo, {
    size: size
  }, symbol === null || symbol === void 0 ? void 0 : symbol.toUpperCase().replace("$", "").replace(/\s+/g, "").slice(0, 3)), !hideL2Icon && /*#__PURE__*/React__default.createElement(L2NetworkLogo, {
    networkUrl: L2Icon,
    parentSize: size
  }));
}

export { MissingImageLogo, AssetLogo as default };
