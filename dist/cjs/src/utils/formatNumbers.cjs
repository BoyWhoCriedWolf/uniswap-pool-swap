...
var ConversionRate = require('../graphql/data/ConversionRate.cjs');
...
var TYPE_TO_FORMATTER_RULES = (_TYPE_TO_FORMATTER_RU = {}, _defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_TYPE_TO_FORMATTER_RU, NumberType.TokenNonTx, tokenNonTxFormatter), NumberType.TokenTx, tokenTxFormatter), NumberType.SwapPrice, swapPriceFormatter), NumberType.SwapTradeAmount, swapTradeAmountFormatter), NumberType.SwapDetailsAmount, swapDetailsAmountFormatter), NumberType.FiatTokenQuantity, fiatTokenQuantityFormatter), NumberType.FiatTokenDetails, fiatTokenDetailsFormatter), NumberType.FiatTokenPrice, fiatTokenPricesFormatter), NumberType.FiatTokenStats, fiatTokenStatsFormatter), NumberType.FiatGasPrice, fiatGasPriceFormatter), _defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_TYPE_TO_FORMATTER_RU, NumberType.PortfolioBalance, portfolioBalanceFormatter), NumberType.NFTTokenFloorPrice, ntfTokenFloorPriceFormatter), NumberType.NFTTokenFloorPriceTrailingZeros, ntfTokenFloorPriceFormatterTrailingZeros), NumberType.NFTCollectionStats, ntfCollectionStatsFormatter));
...
function formatNumber(_ref) {
  var input = _ref.input,
    ...
    locale = _ref$locale === void 0 ? locales.DEFAULT_LOCALE : _ref$locale,
    _ref$localCurrency = _ref.localCurrency,
    localCurrency = _ref$localCurrency === void 0 ? localCurrencies.DEFAULT_LOCAL_CURRENCY : _ref$localCurrency,
  ...
  if (formatterOptions.currency) {
    ...
    formatterOptions.currencyDisplay = localCurrencies.LOCAL_CURRENCY_SYMBOL_DISPLAY_TYPE[localCurrency];
  }
  if (!hardCodedInput) {
...
function formatCurrencyAmount(_ref2) {
  var amount = _ref2.amount,
    ...
    locale = _ref2$locale === void 0 ? locales.DEFAULT_LOCALE : _ref2$locale,
    _ref2$localCurrency = _ref2.localCurrency,
    localCurrency = _ref2$localCurrency === void 0 ? localCurrencies.DEFAULT_LOCAL_CURRENCY : _ref2$localCurrency,
...
function formatPriceImpact(priceImpact) {
  var locale = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : locales.DEFAULT_LOCALE;
...
function formatPrice(_ref3) {
  var price = _ref3.price,
    ...
    locale = _ref3$locale === void 0 ? locales.DEFAULT_LOCALE : _ref3$locale,
    _ref3$localCurrency = _ref3.localCurrency,
    localCurrency = _ref3$localCurrency === void 0 ? localCurrencies.DEFAULT_LOCAL_CURRENCY : _ref3$localCurrency,
...
function formatTickPrice(_ref4) {
  ...
  if (atLimit[direction]) {
    return direction === actions.Bound.LOWER ? "0" : "∞";
  }
...
function useFormatterLocales() {
  ...
  return {
    formatterLocale: locales.DEFAULT_LOCALE,
    formatterLocalCurrency: localCurrencies.DEFAULT_LOCAL_CURRENCY
  };
}
function handleFallbackCurrency(selectedCurrency, previousSelectedCurrency, previousConversionRate, shouldFallbackToUSD, shouldFallbackToPrevious) {
  if (shouldFallbackToUSD) return localCurrencies.DEFAULT_LOCAL_CURRENCY;
  if (shouldFallbackToPrevious) return previousConversionRate ? previousSelectedCurrency : localCurrencies.DEFAULT_LOCAL_CURRENCY;
...
function useFormatter() {
  ...
  var formatterLocalCurrencyIsUSD = formatterLocalCurrency === typesAndHooks.Currency.Usd;
  var _useLocalCurrencyConv = ConversionRate.useLocalCurrencyConversionRate(formatterLocalCurrency, formatterLocalCurrencyIsUSD),
...
exports.useFormatterLocales = useFormatterLocales;
