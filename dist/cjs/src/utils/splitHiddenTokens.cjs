...
function splitHiddenTokens(tokenBalances) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      // if below $1
      ((_tokenBalance$token = tokenBalance.token) === null || _tokenBalance$token === void 0 ? void 0 : _tokenBalance$token.standard) !== typesAndHooks.TokenStandard.Native; // do not hide native tokens regardless of small balance
...
exports.splitHiddenTokens = splitHiddenTokens;
