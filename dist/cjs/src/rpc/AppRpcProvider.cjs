...
var StaticJsonRpcProvider = require('./StaticJsonRpcProvider.cjs');
...
var AppRpcProvider = /*#__PURE__*/function (_AppStaticJsonRpcProv) {
  function AppRpcProvider(chainId, providers$1) {
    var _this2;
    var evaluationIntervalMs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 30000;
    _classCallCheck__default["default"](this, AppRpcProvider);
    if (providers$1.length === 0) throw new Error("providers array empty");
    providers$1.forEach(function (provider, i) {
      if (!providers.Provider.isProvider(provider)) throw new Error("invalid provider ".concat(i));
    });
    checkNetworks(providers$1.map(function (p) {
      return p.network;
    }));
    _this2 = _callSuper(this, AppRpcProvider, [chainId, providers$1[0].connection.url]);
    _this2.providerEvaluations = providers$1.map(function (provider) {
      return {
        provider: provider,
        performance: {
          callCount: 0,
   ...
   */
  _inherits__default["default"](AppRpcProvider, _AppStaticJsonRpcProv);
  return _createClass__default["default"](AppRpcProvider, [{
    key: "perform",
    value: function () {
      var _perform = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(method, params) {
        var _this3 = this;
    ...
    value: function () {
      var _evaluateProvider = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(config) {
