...
var formatEthPrice = function formatEthPrice(price) {
  if (!price) return 0;
  var formattedPrice = parseFloat(units.formatEther(String(price)));
...
var formatWeiToDecimal = function formatWeiToDecimal(amount) {
  ...
  if (!amount) return "-";
  return ethNumberStandardFormatter(units.formatEther(amount), false, removeZeroes, false);
};
...
exports.ethNumberStandardFormatter = ethNumberStandardFormatter;
exports.formatEth = formatEth;
exports.formatEthPrice = formatEthPrice;
exports.formatUSDPriceWithCommas = formatUSDPriceWithCommas;
exports.formatUsdPrice = formatUsdPrice;
exports.formatWeiToDecimal = formatWeiToDecimal;
exports.wrapScientificNotation = wrapScientificNotation;
