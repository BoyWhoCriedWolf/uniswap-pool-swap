...
var darkTheme = {
  colors: {
    neutral1: sprinkles_css.vars.color.neutral1_dark,
    neutral2: sprinkles_css.vars.color.neutral2_dark,
    neutral3: sprinkles_css.vars.color.neutral3_dark,
    surface1: sprinkles_css.vars.color.surface1_dark,
    surface2: sprinkles_css.vars.color.surface2_dark,
    surface3: sprinkles_css.vars.color.surface3_dark,
    surface4: sprinkles_css.vars.color.surface4_dark,
    surface5: sprinkles_css.vars.color.surface5_dark,
    accent1: sprinkles_css.vars.color.accent1_dark,
    accent2: sprinkles_css.vars.color.accent2_dark,
    ...
    deprecated_gold: sprinkles_css.vars.color.gold200,
    deprecated_violet: sprinkles_css.vars.color.violet200,
