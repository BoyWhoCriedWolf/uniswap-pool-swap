...
var blank_token = require('../../../assets/svg/blank_token.cjs');
var contractInteraction = require('../../../assets/svg/contract-interaction.cjs');
var AssetLogo = require('../../Logo/AssetLogo.cjs');
var index = require('../../Unicon/index.cjs');
...
var UnknownContract = styled__default["default"](contractInteraction.ReactComponent)(_templateObject || (_templateObject = _taggedTemplateLiteral__default["default"](["\n  color: ", ";\n"])), function (_ref) {
  var theme = _ref.theme;
  return theme.neutral2;
});
var DoubleLogoContainer = styled__default["default"].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral__default["default"](["\n  display: flex;\n  flex-direction: row;\n  gap: 2px;\n  position: relative;\n  top: 0;\n  left: 0;\n  img:nth-child(n) {\n    width: 19px;\n    height: 40px;\n    object-fit: cover;\n  }\n  img:nth-child(1) {\n    border-radius: 20px 0 0 20px;\n    object-position: 0 0;\n  }\n  img:nth-child(2) {\n    border-radius: 0 20px 20px 0;\n    object-position: 100% 0;\n  }\n"])));
var StyledLogoParentContainer = styled__default["default"].div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral__default["default"](["\n  position: relative;\n  top: 0;\n  left: 0;\n"])));
var ENSAvatarImg = styled__default["default"].img(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral__default["default"](["\n  border-radius: 8px;\n  height: 40px;\n  width: 40px;\n"])));
var StyledChainLogo = styled__default["default"].img(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral__default["default"](["\n  height: 14px;\n  width: 14px;\n"])));
var SquareChainLogo = styled__default["default"].img(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral__default["default"](["\n  height: 100%;\n  width: 100%;\n"])));
var CircleLogoImage = styled__default["default"].img(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral__default["default"](["\n  width: ", ";\n  height: ", ";\n  border-radius: 50%;\n"])), function (_ref2) {
  var size = _ref2.size;
  return size;
}, function (_ref3) {
  var size = _ref3.size;
...
var L2LogoContainer = styled__default["default"].div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral__default["default"](["\n  background-color: ", ";\n  border-radius: 2px;\n  height: 16px;\n  left: 60%;\n  position: absolute;\n  top: 60%;\n  outline: 2px solid ", ";\n  width: 16px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"])), function (_ref4) {
...
function DoubleLogo(_ref6) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(DoubleLogoContainer, null, /*#__PURE__*/React__default["default"].createElement(CircleLogoImage, {
    size: size,
    src: logo1 !== null && logo1 !== void 0 ? logo1 : blank_token,
    onError: onError1
  }), /*#__PURE__*/React__default["default"].createElement(CircleLogoImage, {
    size: size,
    src: logo2 !== null && logo2 !== void 0 ? logo2 : blank_token,
    onError: onError2
  }));
}
function DoubleCurrencyLogo(_ref7) {
  ...
  var _useTokenLogoSource3 = useAssetLogoSource(currencies === null || currencies === void 0 || (_currencies$3 = currencies[1]) === null || _currencies$3 === void 0 ? void 0 : _currencies$3.wrapped.address, chainId, currencies === null || currencies === void 0 || (_currencies$4 = currencies[1]) === null || _currencies$4 === void 0 ? void 0 : _currencies$4.isNative, backupImages === null || backupImages === void 0 ? void 0 : backupImages[1]),
    _useTokenLogoSource4 = _slicedToArray__default["default"](_useTokenLogoSource3, 2),
  ...
  if (currencies.length > 1) {
    return /*#__PURE__*/React__default["default"].createElement(DoubleLogo, {
      logo1: src,
      onError1: nextSrc,
      logo2: src2,
      onError2: nextSrc2,
  ...
  return /*#__PURE__*/React__default["default"].createElement(AssetLogo.MissingImageLogo, {
    size: size
...
function PortfolioAvatar(_ref8) {
  ...
  if (loading) {
    return /*#__PURE__*/React__default["default"].createElement(reactFeather.Loader, {
      size: size
    });
  }
  if (avatar) {
    return /*#__PURE__*/React__default["default"].createElement(ENSAvatarImg, {
      src: avatar,
      alt: "avatar"
    });
  }
  return /*#__PURE__*/React__default["default"].createElement(index.Unicon, {
    size: 40,
...
function SquareL2Logo(_ref9) {
  ...
  if (chainId === sdkCore.ChainId.MAINNET) return null;
  var _getChainInfo = chainInfo.getChainInfo(chainId),
  ...
  return /*#__PURE__*/React__default["default"].createElement(L2LogoContainer, {
    hasSquareLogo: !!squareLogoUrl
  }, squareLogoUrl ? /*#__PURE__*/React__default["default"].createElement(SquareChainLogo, {
    src: chainLogo,
    alt: "chainLogo"
  }) : /*#__PURE__*/React__default["default"].createElement(StyledChainLogo, {
    src: chainLogo,
    alt: "chainLogo"
  }));
}
...
function PortfolioLogo(props) {
  return /*#__PURE__*/React__default["default"].createElement(StyledLogoParentContainer, null, getLogo(props), /*#__PURE__*/React__default["default"].createElement(SquareL2Logo, {
...
function getLogo(_ref10) {
  ...
  if (accountAddress) {
    return /*#__PURE__*/React__default["default"].createElement(PortfolioAvatar, {
      accountAddress: accountAddress,
      size: size
    });
  }
  if (currencies && currencies.length) {
    return /*#__PURE__*/React__default["default"].createElement(DoubleCurrencyLogo, {
      chainId: chainId,
  ...
  if ((images === null || images === void 0 ? void 0 : images.length) === 1) {
    ...
    return /*#__PURE__*/React__default["default"].createElement(CircleLogoImage, {
      size: size,
      src: (_images$ = images[0]) !== null && _images$ !== void 0 ? _images$ : blank_token
    });
  }
  ...
  return /*#__PURE__*/React__default["default"].createElement(UnknownContract, {
    width: size,
    height: size
  });
}

exports.PortfolioLogo = PortfolioLogo;
