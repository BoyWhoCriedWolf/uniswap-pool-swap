...
var index = require('../Popover/index.cjs');
...
var TooltipContainer = styled__default["default"].div(_templateObject || (_templateObject = _taggedTemplateLiteral__default["default"](["\n  max-width: ", ";\n  width: calc(100vw - 16px);\n  cursor: default;\n  padding: ", ";\n  pointer-events: auto;\n\n  color: ", ";\n  font-weight: 485;\n  font-size: 12px;\n  line-height: 16px;\n  word-break: break-word;\n\n  background: ", ";\n  border-radius: 12px;\n  border: 1px solid ", ";\n  box-shadow: 0 4px 8px 0 ", ";\n"])), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
function Tooltip(_ref7) {
  var text = _ref7.text,
    ...
    rest = _objectWithoutProperties__default["default"](_ref7, _excluded);
  return /*#__PURE__*/React__default["default"].createElement(index["default"], _extends__default["default"]({
    content: text && /*#__PURE__*/React__default["default"].createElement(TooltipContainer, {
      size: size,
...
function MouseoverTooltip(props) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(Tooltip, _extends__default["default"]({}, rest, {
    open: open,
    close: close,
    disabled: disabled,
    show: forceShow || show,
