...
var storage = utils.createJSONStorage(function () {
  return sessionStorage;
});
var shouldDisableNFTRoutesAtom = utils.atomWithStorage("shouldDisableNFTRoutes", false, storage);

exports.shouldDisableNFTRoutesAtom = shouldDisableNFTRoutesAtom;
