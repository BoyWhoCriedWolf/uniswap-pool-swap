...
var contenthashToUri = require('../../utils/contenthashToUri.cjs');
var parseENSAddress = require('../../utils/parseENSAddress.cjs');
var uriToHttp = require('../../utils/uriToHttp.cjs');
var validateTokenList = require('../../../utils/validateTokenList.cjs');
...
function _fetchTokenList() {
  _fetchTokenList = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(listUrl, resolveENSContentHash, skipValidation) {
    ...
    return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 16:
          _context.prev = 16;
          translatedUri = contenthashToUri["default"](contentHashUri);
          _context.next = 25;
          break;
        case 20:
          _context.prev = 20;
        ...
        case 56:
          _context.next = 58;
          return validateTokenList.validateTokenList(json);
        case 58:
