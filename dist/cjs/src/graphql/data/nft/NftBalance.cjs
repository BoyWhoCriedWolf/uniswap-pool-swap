...
require('uuid');
var currency = require('../../../nft/utils/currency.cjs');
...
function useNftBalance(ownerAddress, collectionFilters, assetsFilter, first, after, last, before) {
  ...
  var _useNftBalanceQuery = typesAndHooks.useNftBalanceQuery({
      variables: {
        ownerAddress: ownerAddress,
