...
Apollo.gql(_templateObject || (_templateObject = _taggedTemplateLiteral__default["default"](["\n    fragment TransactionParts on Transaction {\n  id\n  blockNumber\n  hash\n  status\n  to\n  from\n  nonce\n}\n    "])));
var TokenAssetPartsFragmentDoc = Apollo.gql(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral__default["default"](["\n    fragment TokenAssetParts on Token {\n  id\n  name\n  symbol\n  address\n  decimals\n  chain\n  standard\n  project {\n    id\n    isSpam\n    logo {\n      id\n      url\n    }\n  }\n}\n    "])));
var TokenTransferPartsFragmentDoc = Apollo.gql(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral__default["default"](["\n    fragment TokenTransferParts on TokenTransfer {\n  id\n  asset {\n    ...TokenAssetParts\n  }\n  tokenStandard\n  quantity\n  sender\n  recipient\n  direction\n  transactedValue {\n    id\n    currency\n    value\n  }\n}\n    ", ""])), TokenAssetPartsFragmentDoc);
var NftAssetPartsFragmentDoc = Apollo.gql(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral__default["default"](["\n    fragment NFTAssetParts on NftAsset {\n  id\n  name\n  nftContract {\n    id\n    chain\n    address\n  }\n  tokenId\n  image {\n    id\n    url\n  }\n  collection {\n    id\n    name\n  }\n}\n    "])));
var NftTransferPartsFragmentDoc = Apollo.gql(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral__default["default"](["\n    fragment NFTTransferParts on NftTransfer {\n  id\n  asset {\n    ...NFTAssetParts\n  }\n  nftStandard\n  sender\n  recipient\n  direction\n}\n    ", ""])), NftAssetPartsFragmentDoc);
var TokenApprovalPartsFragmentDoc = Apollo.gql(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral__default["default"](["\n    fragment TokenApprovalParts on TokenApproval {\n  id\n  asset {\n    ...TokenAssetParts\n  }\n  tokenStandard\n  approvedAddress\n  quantity\n}\n    ", ""])), TokenAssetPartsFragmentDoc);
var NftApprovalPartsFragmentDoc = Apollo.gql(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral__default["default"](["\n    fragment NFTApprovalParts on NftApproval {\n  id\n  asset {\n    ...NFTAssetParts\n  }\n  nftStandard\n  approvedAddress\n}\n    ", ""])), NftAssetPartsFragmentDoc);
var NftApproveForAllPartsFragmentDoc = Apollo.gql(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral__default["default"](["\n    fragment NFTApproveForAllParts on NftApproveForAll {\n  id\n  asset {\n    ...NFTAssetParts\n  }\n  nftStandard\n  operatorAddress\n  approved\n}\n    ", ""])), NftAssetPartsFragmentDoc);
var TransactionDetailsPartsFragmentDoc = Apollo.gql(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral__default["default"](["\n    fragment TransactionDetailsParts on TransactionDetails {\n  id\n  type\n  from\n  to\n  hash\n  nonce\n  status\n  assetChanges {\n    __typename\n    ... on TokenTransfer {\n      ...TokenTransferParts\n    }\n    ... on NftTransfer {\n      ...NFTTransferParts\n    }\n    ... on TokenApproval {\n      ...TokenApprovalParts\n    }\n    ... on NftApproval {\n      ...NFTApprovalParts\n    }\n    ... on NftApproveForAll {\n      ...NFTApproveForAllParts\n    }\n  }\n}\n    ", "\n", "\n", "\n", "\n", ""])), TokenTransferPartsFragmentDoc, NftTransferPartsFragmentDoc, TokenApprovalPartsFragmentDoc, NftApprovalPartsFragmentDoc, NftApproveForAllPartsFragmentDoc);
var SwapOrderDetailsPartsFragmentDoc = Apollo.gql(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral__default["default"](["\n    fragment SwapOrderDetailsParts on SwapOrderDetails {\n  id\n  offerer\n  hash\n  orderStatus: status\n  inputToken {\n    ...TokenAssetParts\n  }\n  inputTokenQuantity\n  outputToken {\n    ...TokenAssetParts\n  }\n  outputTokenQuantity\n}\n    ", ""])), TokenAssetPartsFragmentDoc);
var AssetActivityPartsFragmentDoc = Apollo.gql(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral__default["default"](["\n    fragment AssetActivityParts on AssetActivity {\n  id\n  timestamp\n  chain\n  details {\n    __typename\n    ... on TransactionDetails {\n      ...TransactionDetailsParts\n    }\n    ... on SwapOrderDetails {\n      ...SwapOrderDetailsParts\n    }\n  }\n}\n    ", "\n", ""])), TransactionDetailsPartsFragmentDoc, SwapOrderDetailsPartsFragmentDoc);
var ConvertDocument = Apollo.gql(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral__default["default"](["\n    query Convert($toCurrency: Currency!) {\n  convert(fromAmount: {currency: USD, value: 1.0}, toCurrency: $toCurrency) {\n    id\n    value\n    currency\n  }\n}\n    "])));
...
function useConvertQuery(baseOptions) {
  ...
  return Apollo__namespace.useQuery(ConvertDocument, options);
}
Apollo.gql(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral__default["default"](["\n    query RecentlySearchedAssets($collectionAddresses: [String!]!, $contracts: [ContractInput!]!) {\n  nftCollections(filter: {addresses: $collectionAddresses}) {\n    edges {\n      node {\n        collectionId\n        image {\n          url\n        }\n        isVerified\n        name\n        numAssets\n        nftContracts {\n          address\n        }\n        markets(currencies: ETH) {\n          floorPrice {\n            currency\n            value\n          }\n        }\n      }\n    }\n  }\n  tokens(contracts: $contracts) {\n    id\n    decimals\n    name\n    chain\n    standard\n    address\n    symbol\n    market(currency: USD) {\n      id\n      price {\n        id\n        value\n        currency\n      }\n      pricePercentChange(duration: DAY) {\n        id\n        value\n      }\n      volume24H: volume(duration: DAY) {\n        id\n        value\n        currency\n      }\n    }\n    project {\n      id\n      logoUrl\n      safetyLevel\n    }\n  }\n}\n    "])));
Apollo.gql(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral__default["default"](["\n    query SearchTokens($searchQuery: String!) {\n  searchTokens(searchQuery: $searchQuery) {\n    id\n    decimals\n    name\n    chain\n    standard\n    address\n    symbol\n    market(currency: USD) {\n      id\n      price {\n        id\n        value\n        currency\n      }\n      pricePercentChange(duration: DAY) {\n        id\n        value\n      }\n      volume24H: volume(duration: DAY) {\n        id\n        value\n        currency\n      }\n    }\n    project {\n      id\n      logoUrl\n      safetyLevel\n    }\n  }\n}\n    "])));
Apollo.gql(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral__default["default"](["\n    query Token($chain: Chain!, $address: String = null) {\n  token(chain: $chain, address: $address) {\n    id\n    decimals\n    name\n    chain\n    address\n    symbol\n    standard\n    market(currency: USD) {\n      id\n      totalValueLocked {\n        id\n        value\n        currency\n      }\n      price {\n        id\n        value\n        currency\n      }\n      volume24H: volume(duration: DAY) {\n        id\n        value\n        currency\n      }\n      priceHigh52W: priceHighLow(duration: YEAR, highLow: HIGH) {\n        id\n        value\n      }\n      priceLow52W: priceHighLow(duration: YEAR, highLow: LOW) {\n        id\n        value\n      }\n    }\n    project {\n      id\n      description\n      homepageUrl\n      twitterName\n      logoUrl\n      tokens {\n        id\n        chain\n        address\n      }\n    }\n  }\n}\n    "])));
Apollo.gql(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral__default["default"](["\n    query TokenPrice($chain: Chain!, $address: String = null, $duration: HistoryDuration!) {\n  token(chain: $chain, address: $address) {\n    id\n    address\n    chain\n    market(currency: USD) {\n      id\n      price {\n        id\n        value\n      }\n      priceHistory(duration: $duration) {\n        id\n        timestamp\n        value\n      }\n    }\n  }\n}\n    "])));
var UniswapPricesDocument = Apollo.gql(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral__default["default"](["\n    query UniswapPrices($contracts: [ContractInput!]!) {\n  tokens(contracts: $contracts) {\n    id\n    address\n    chain\n    standard\n    project {\n      id\n      markets(currencies: [USD]) {\n        id\n        price {\n          id\n          value\n        }\n      }\n    }\n  }\n}\n    "])));
...
function useUniswapPricesQuery(baseOptions) {
  var options = _objectSpread(_objectSpread({}, defaultOptions), baseOptions);
  return Apollo__namespace.useQuery(UniswapPricesDocument, options);
}
var TokenSpotPriceDocument = Apollo.gql(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral__default["default"](["\n    query TokenSpotPrice($chain: Chain!, $address: String = null) {\n  token(chain: $chain, address: $address) {\n    id\n    address\n    chain\n    name\n    symbol\n    project {\n      id\n      markets(currencies: [USD]) {\n        id\n        price {\n          id\n          value\n        }\n      }\n    }\n  }\n}\n    "])));
...
function useTokenSpotPriceQuery(baseOptions) {
  var options = _objectSpread(_objectSpread({}, defaultOptions), baseOptions);
  return Apollo__namespace.useQuery(TokenSpotPriceDocument, options);
}
Apollo.gql(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral__default["default"](["\n    query TopTokens100($duration: HistoryDuration!, $chain: Chain!) {\n  topTokens(pageSize: 100, page: 1, chain: $chain, orderBy: VOLUME) {\n    id\n    name\n    chain\n    address\n    symbol\n    standard\n    market(currency: USD) {\n      id\n      totalValueLocked {\n        id\n        value\n        currency\n      }\n      price {\n        id\n        value\n        currency\n      }\n      pricePercentChange(duration: $duration) {\n        id\n        currency\n        value\n      }\n      volume(duration: $duration) {\n        id\n        value\n        currency\n      }\n    }\n    project {\n      id\n      logoUrl\n    }\n  }\n}\n    "])));
Apollo.gql(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral__default["default"](["\n    query TopTokensSparkline($duration: HistoryDuration!, $chain: Chain!) {\n  topTokens(pageSize: 100, page: 1, chain: $chain, orderBy: VOLUME) {\n    id\n    address\n    chain\n    market(currency: USD) {\n      id\n      priceHistory(duration: $duration) {\n        id\n        timestamp\n        value\n      }\n    }\n  }\n}\n    "])));
Apollo.gql(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral__default["default"](["\n    query TrendingTokens($chain: Chain!) {\n  topTokens(pageSize: 4, page: 1, chain: $chain, orderBy: VOLUME) {\n    id\n    decimals\n    name\n    chain\n    standard\n    address\n    symbol\n    market(currency: USD) {\n      id\n      price {\n        id\n        value\n        currency\n      }\n      pricePercentChange(duration: DAY) {\n        id\n        value\n      }\n      volume24H: volume(duration: DAY) {\n        id\n        value\n        currency\n      }\n    }\n    project {\n      id\n      logoUrl\n      safetyLevel\n    }\n  }\n}\n    "])));
var ActivityDocument = Apollo.gql(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral__default["default"](["\n    query Activity($account: String!) {\n  portfolios(ownerAddresses: [$account]) {\n    id\n    assetActivities(pageSize: 100, page: 1, includeOffChain: true) {\n      ...AssetActivityParts\n    }\n  }\n}\n    ", ""])), AssetActivityPartsFragmentDoc);
...
function useNftBalanceQuery(baseOptions) {
  var options = _objectSpread(_objectSpread({}, defaultOptions), baseOptions);
  return Apollo__namespace.useQuery(NftBalanceDocument, options);
}
var NftUniversalRouterAddressDocument = Apollo.gql(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral__default["default"](["\n    query NftUniversalRouterAddress($chain: Chain = ETHEREUM) {\n  nftRoute(chain: $chain, senderAddress: \"\", nftTrades: []) {\n    toAddress\n  }\n}\n    "])));
...
function usePortfolioBalancesQuery(baseOptions) {
  var options = _objectSpread(_objectSpread({}, defaultOptions), baseOptions);
  return Apollo__namespace.useQuery(PortfolioBalancesDocument, options);
}
function usePortfolioBalancesLazyQuery(baseOptions) {
  var options = _objectSpread(_objectSpread({}, defaultOptions), baseOptions);
  return Apollo__namespace.useLazyQuery(PortfolioBalancesDocument, options);
}

exports.ActivityDocument = ActivityDocument;
exports.ActivityType = ActivityType;
exports.AssetActivityPartsFragmentDoc = AssetActivityPartsFragmentDoc;
exports.Chain = Chain;
exports.ConvertDocument = ConvertDocument;
exports.Currency = Currency;
exports.NftApprovalPartsFragmentDoc = NftApprovalPartsFragmentDoc;
exports.NftApproveForAllPartsFragmentDoc = NftApproveForAllPartsFragmentDoc;
exports.NftAssetPartsFragmentDoc = NftAssetPartsFragmentDoc;
exports.NftAssetSortableField = NftAssetSortableField;
exports.NftBalanceDocument = NftBalanceDocument;
exports.NftRouteDocument = NftRouteDocument;
exports.NftStandard = NftStandard;
exports.NftTransferPartsFragmentDoc = NftTransferPartsFragmentDoc;
exports.NftUniversalRouterAddressDocument = NftUniversalRouterAddressDocument;
exports.PortfolioBalancesDocument = PortfolioBalancesDocument;
exports.SwapOrderDetailsPartsFragmentDoc = SwapOrderDetailsPartsFragmentDoc;
exports.SwapOrderStatus = SwapOrderStatus;
exports.TokenApprovalPartsFragmentDoc = TokenApprovalPartsFragmentDoc;
exports.TokenAssetPartsFragmentDoc = TokenAssetPartsFragmentDoc;
exports.TokenSpotPriceDocument = TokenSpotPriceDocument;
exports.TokenStandard = TokenStandard;
exports.TokenTradeType = TokenTradeType;
exports.TokenTransferPartsFragmentDoc = TokenTransferPartsFragmentDoc;
exports.TransactionDetailsPartsFragmentDoc = TransactionDetailsPartsFragmentDoc;
exports.TransactionStatus = TransactionStatus;
exports.UniswapPricesDocument = UniswapPricesDocument;
exports.useActivityQuery = useActivityQuery;
exports.useConvertQuery = useConvertQuery;
exports.useNftBalanceQuery = useNftBalanceQuery;
exports.useNftRouteLazyQuery = useNftRouteLazyQuery;
exports.useNftUniversalRouterAddressQuery = useNftUniversalRouterAddressQuery;
exports.usePortfolioBalancesLazyQuery = usePortfolioBalancesLazyQuery;
exports.usePortfolioBalancesQuery = usePortfolioBalancesQuery;
exports.useTokenSpotPriceQuery = useTokenSpotPriceQuery;
exports.useUniswapPricesQuery = useUniswapPricesQuery;
