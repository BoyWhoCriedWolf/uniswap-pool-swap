...
interface AddLiquidityV3PoolTransactionInfo {
...
interface RemoveLiquidityV3TransactionInfo {
...
interface CreateV3PoolTransactionInfo {
    type: TransactionType.CREATE_V3_POOL;
    baseCurrencyId: string;
    quoteCurrencyId: string;
}
interface VoteTransactionInfo extends BaseTransactionInfo {
...
interface QueueTransactionInfo extends BaseTransactionInfo {
    type: TransactionType.QUEUE;
    governorAddress: string;
    proposalId: number;
}
interface ExecuteTransactionInfo extends BaseTransactionInfo {
    type: TransactionType.EXECUTE;
    governorAddress: string;
    proposalId: number;
}
interface DelegateTransactionInfo extends BaseTransactionInfo {
...
interface AddLiquidityV2PoolTransactionInfo {
...
interface MigrateV2LiquidityToV3TransactionInfo {
    type: TransactionType.MIGRATE_LIQUIDITY_V3;
    baseCurrencyId: string;
    quoteCurrencyId: string;
    isFork: boolean;
}
interface CollectFeesTransactionInfo {
